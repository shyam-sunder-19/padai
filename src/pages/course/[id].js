...
import course_data from "@/data/courses_data"
...
const Course = ({course}) => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
        setCurrentSlide((prevSlide) => (prevSlide + 1) % course.course_picture.length);
      ...
      <div className="flex p-8 justify-center">
        ...
        <div className="p-12 w-3/5">
            ...
            <div className="flex flex-wrap justify-between ">
              <div>
                <h className="text-6xl">{course.course_name}</h>
                <h2 className="text-2xl mx-1">{course.university_name}</h2>
            ...
            <div className="flex-1 relative p-8 h-96">
              {course.course_picture.map((color, index) => (
                <img
                  key={index}
              ...
              <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-2">
                {course.course_picture.map((_, index) => (
                  <button
                    key={index}
            ...
            <div className="flex flex-col py-8">
              <h className="text-4xl">About {course.course_name}</h>
            ...
            <div className="flex flex-col py-8">
              <h className="text-4xl mb-6">Job Roles after {course.course_name}</h>
              <p className="text-lg">
            ...
            <div className="flex flex-col py-8">
              <h className="text-4xl">{course.university_name} Placement Stats</h>
              <ul className="list-disc text-lg p-5">
                <li>
              ...
              <div className="py-6">
                ...
                <div className="flex p-1 flex-wrap justify-around">
                  {
                    course.placement_company_image_links.map(
